export const routes = {
  admin: {
    user: {
      ...
      products: '/admin/user',
      createProduct: '/admin/user/create',
      productDetails: (slug: string) => `/admin/user/products/${slug}`,
      editData: (id: string) => `/admin/user/${id}/edit`,
      categories: '/admin/user/categories',
      createCategory: '/admin/user/categories/create',
      editCategory: (id: string) => `/admin/user/categories/${id}/edit`,
      orders: '/admin/user/orders',
      createOrder: '/admin/user/orders/create',
      orderDetails: (id: string) => `/admin/user/orders/${id}`,
      editOrder: (id: string) => `/admin/user/orders/${id}/edit`,
      reviews: '/admin/user/reviews',
      shop: '/admin/user/shop',
      cart: '/admin/user/cart',
      checkout: '/admin/user/checkout',
      trackingId: (id: string) => `/admin/user/tracking/${id}`,
    },
  },
  doctor: {
    controldiabetes: {
